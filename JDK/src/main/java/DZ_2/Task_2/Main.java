...
public class Main {
    static void main(String[] args) {
        ...
        System.out.println("Сумма: " + GenericTask.sum(intPair));
        ...
        System.out.println("Сумма: " + GenericTask.sum(doublePair));
        ...
        System.out.println("Конкатенация: " + GenericTask.concatenate(stringPair));
